  ...
  return (
    <div className="relative min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute top-4 right-4 flex space-x-4">
        <Link href="t.me/enterVibee" target="_blank" rel="noopener noreferrer">
          <Image
        ...
        <Link href="https://dexscreener.com/solana/4b6akdqcqpqaylbkmdex4k9nrszj86qdax8vapzp5ra6" target="_blank" rel="noopener noreferrer">
          <Image
